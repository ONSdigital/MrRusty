...
public class CollectionDetails extends ZebedeeApiTest {
    ...
    public void getShouldReturn200ForViewerWithPermissions() throws IOException {
        ...
        // When
        // we attempt to get as a publisher
    ...
    @GET
    @Test
    public void getShouldReturn401ForUsersWithoutPermissions() throws IOException {
        // Given
        // a collection
    ...
    public static Response<ContentDetail> get(String id, Http http) throws IOException {
        Endpoint idUrl = ZebedeeHost.collectionDetails.addPathSegment(id);
