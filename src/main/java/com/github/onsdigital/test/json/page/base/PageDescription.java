...
import com.github.onsdigital.test.json.page.partial.Contact;
 ...
 * <p/>
 */
public class PageDescription implements Comparable<PageDescription> {
    ...
    public Boolean isLatestRelease() {
        return latestRelease == null ? false : latestRelease;
    }
